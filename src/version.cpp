...
// Copyright (c) 2014 The Bitlectrum developers
...
// for both Bitlectrumd and Bitlectrum(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Bitlectrum releases, the client name should be selected from
