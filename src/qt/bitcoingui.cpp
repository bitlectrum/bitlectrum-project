 ...
 * The Bitlectrum Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Bitlectrum Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/Bitlectrum_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Bitlectrum address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Bitlectrum_tooltip"), tr("&About Bitlectrum"), this);
    aboutAction->setToolTip(tr("Show information about Bitlectrum"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Bitlectrum"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Bitlectrum_tooltip"), tr("Show/Hide &Bitlectrum"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Bitlectrum window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/Bitlectrum_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Bitlectrum_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/Bitlectrum_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Bitlectrum client"));
    trayIcon->setIcon(QIcon(":/icons/Bitlectrum_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitlectrum network", "", count));
}
