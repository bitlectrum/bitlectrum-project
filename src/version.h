...
// Copyright (c) 2012-2013 The Bitlectrum developers
...
// Bitlectrum version - intended for display purpose only
...
// Bitlectrum version - reference for code tracking
#define BTL_VERSION_MAJOR       1
#define BTL_VERSION_MINOR       0
#define BTL_VERSION_REVISION    0
#define BTL_VERSION_BUILD       0

static const int BTL_VERSION =
                           1000000 * BTL_VERSION_MAJOR
                         +   10000 * BTL_VERSION_MINOR
                         +     100 * BTL_VERSION_REVISION
                         +       1 * BTL_VERSION_BUILD;
