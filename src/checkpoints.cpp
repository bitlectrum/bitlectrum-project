...
namespace Checkpoints
{
    ...
    // Bitlectrum: synchronized checkpoint (centrally broadcasted)
    ...
    // Bitlectrum: get last synchronized checkpoint
    ...
    // Bitlectrum: only descendant of current sync-checkpoint is allowed
    ...
    // Bitlectrum: reset synchronized checkpoint to last hardened checkpoint
...
// Bitlectrum: sync-checkpoint master key
...
// Bitlectrum: verify signature of sync-checkpoint message
...
// Bitlectrum: process synchronized checkpoint
